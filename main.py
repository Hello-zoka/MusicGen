...
INPUT_FILE_LIST = ["Samples/Cymbals/Hihat Closed 031 Super Hero Music.wav" , "Samples/Claps/Clap 018 Cardiak.wav", "Samples/Kick Drums/Kick Drum 001 Tight.wav", "Samples/808s/808 Bass G#m Boom Kick Hi.wav"]
...
def random_mix_of_beat(channel, sample_rate=44100, beats_count=5, duration = 20, pause_time = [0.4, 0.6, 0.8, 1.]):
    ...
    result = [[0 for i in range(sample_rate * (duration * 18 // 10))] for j in range(len(channel))]
    delay = 0
